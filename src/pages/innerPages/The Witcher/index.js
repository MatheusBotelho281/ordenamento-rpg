    ...
    <>
      <Wrapper>
        <InnerWrapper>
          ...
          <buttom onClick={PopUpShow} style={{backgroundColor: "white", width: "500px",height: "70px", cursor: "pointer", alignItems: "center", display: "flex", justifyContent: "center", fontSize: "x-large", marginBottom: "30px"}}>Vídeo em breve</buttom>
